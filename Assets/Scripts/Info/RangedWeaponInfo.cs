...
public class RangedWeaponInfo : WeaponInfo
{
    ...
    public class RangedWeapon : Weapon<RangedWeaponInfo>
    {
        ...
        public float BaseAttackSpeed
        {
            get
            {
                return Character.Status.ModifierCalculator.CalculateFinalValue(ModifierType.BaseAttackSpeed,
                    _typedInfo.BaseAttackSpeed);
            }
        }
        ...
        public float ReloadDuration
        {
            get { return _rangedWeaponInfo.ReloadDuration * ReloadDurationScale; }
        }
        ...
        public override void Attack(Character target, EnemyCharacterStatusInfo statusInfo)
        {
            ...
            for (var i = 0; i < _typedInfo._projectilesPerShot; ++i)
            {
                ...
                projectile.Launch(Character, projectileDirection, _typedInfo._projectileSpeed, finalDamage,
                    _typedInfo.CanFriendlyFire, _typedInfo._splashDamageRadius);
