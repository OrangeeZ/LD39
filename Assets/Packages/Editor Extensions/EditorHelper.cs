...
public static class EditorHelper
{
    ...
    {
        var assetPath = AssetDatabase.GetAssetPath(texture);
        var textureImporter = GetTextureImporter(texture);
    ...
    public static void SetTexureFormat(Texture2D texture, TextureImporterFormat format)
    {
        ...
        textureImporter.GetDefaultPlatformTextureSettings().format = format;
    ...
    public static TextureImporterFormat GetTexureFormat(Texture2D texture)
    {
        ...
        return textureImporter.GetDefaultPlatformTextureSettings().format;
    }

    public static Texture2D ObjectField(Texture2D sourceObject)
    {
        return EditorGUILayout.ObjectField(sourceObject, typeof(Texture2D), false, GUILayout.Width(60),
            GUILayout.Height(60)) as Texture2D;
    }
